...
SECRET_KEY = "django-insecure-(46w5bp-ydie%zq(t@8%y4e0pivo5t9de)44m&c-!^0yh9ke9="
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR / "templates"
        ],  # indicamos donde tiene que buscar las templates
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOGIN_REDIRECT_URL = "home"  # redireccionamos a home despues de hacer login.
